...
This project aims to implement OOP concepts to create a console application using C++. The project takes the form of a student grade book system that allows different kinds of users to access the system. The user can log in as either a student or a professor and utilize unique methods depending on the user type. The program interacts with the user through a console window, and the control flow is intuitive when navigating through the different options. This project was worked on individually throughout the semester, and the design and implementation are unique to the creator. This semester-long project was challenging, but all requirements were met diligently. This project is also a newer version of an outdated project initially created in the Fall of 2021.   <br />
